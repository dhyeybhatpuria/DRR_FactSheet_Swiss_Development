...
# Extract total death, total affected and total damage; 
# number of affected, number of injured, and number of homeless
...
# row.names.remove <- c("Brunei Darussalam", "Timor-Leste", "Singapore")
emdat_public1<-emdat_public[!(emdat_public$Country=="Timor-Leste"),]
emdat_public1<-emdat_public1[!(emdat_public1$Country=="Brunei Darussalam"),]
emdat_public1<-emdat_public1[!(emdat_public1$Country=="Singapore"),]
emdat_public1<-emdat_public[!(emdat_public$Country=="Thailand"),]
emdat_public1<-emdat_public1[!(emdat_public1$Country=="Malaysia"),]
emdat_public1<-emdat_public1[!(emdat_public1$Country=="Indonesia"),]
output1 <- emdat_public1 %>% 
  group_by(decade, Country) %>% 
  summarise(tot_death = sum(Total.Deaths))

ggplot(output1, aes(x=decade, y=tot_death, fill=Country)) + 
